...
class DB
{
	...
	static public function GetDbRowById($table, $ids=array()) { 
		$one = is_array($ids) ? false : true; settype($ids, 'array'); 
		if(preg_match('/[^\w\-\_]/', implode('',$ids))) return array();
	...
	static public function Update( $table=null, $id=1, $updaterow=array(), $pkname='nId' )
	{
