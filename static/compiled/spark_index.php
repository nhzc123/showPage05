				...
				<div id="dUserInfo" class="userInfo mod">
					<div class="userInfo-user">
						<div class="userInfo-user-face face">
							<img src="../configuration/img/Spark/spark65x65.png" />
						</div>
						<div class="userInfo-user-name"></div>
						<div id="motto" class="userInfo-user-hi">

						Spark Browser is a simple and easy-to-use internet browser base on Chromium.
<br>
						It has an important feature: MagicBox, which contains screen capture, mouse gesture and mute sound tools. 
						<br>
						Spark Browser, enable better Internet access for you. 
							...
							<ul class="nav-list">
								...
								<li class="nav-list-item">
									<div class="nav-list-item-title" id="dNav2"
										onclick="oa.go('index.php?name=Spark&childPage=summary')">
										总体报告
										<span class="navAlert txt-aside" data-type="navAlert"><span
							...
							<ul class="nav-list">
								...
								<li class="nav-list-item ">
									<div class="nav-list-item-title nav-list-item-title-spec"
										...
										<b class="nav-list-item-title-foldSymbol"></b>响应时间对比
...
"ico-arr-bdr">&#9670;</span>
									...
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=response')">
										响应时间报告
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										...
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=responseMethod')">
										响应时间评测方法
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
								...
								<li class="nav-list-item ">
									<div class="nav-list-item-title nav-list-item-title-spec"
										onclick="fFold(this.parentNode,'nav-list-item')">
										<b class="nav-list-item-title-foldSymbol"></b>内核跑分对比
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										</b>
									...
									<ul class="nav-list-subList">
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=core')">
										内核跑分报告
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										...
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=coreMethod')">
										内核跑分评测方法
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
								...
								<li class="nav-list-item ">
									<div class="nav-list-item-title nav-list-item-title-spec"
										onclick="fFold(this.parentNode,'nav-list-item')">
										<b class="nav-list-item-title-foldSymbol"></b>资源占用对比
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										</b>
									...
									<ul class="nav-list-subList">
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=resource')">
										资源占用报告
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										...
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=resourceMethod')">
										资源占用评测方法
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
									...
									<div class="nav-list-item-title nav-list-item-title-spec"
										onclick="fFold(this.parentNode,'nav-list-item')">
										<b class="nav-list-item-title-foldSymbol"></b>稳定性对比
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										</b>
									...
									<ul class="nav-list-subList">
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=stable')">
										稳定性报告
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										...
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=stableMethod')">
										稳定性评测方法
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
									...
									<div class="nav-list-item-title nav-list-item-title-spec"
										onclick="fFold(this.parentNode,'nav-list-item')">
										<b class="nav-list-item-title-foldSymbol"></b>其他对比
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										</b>
									...
									<ul class="nav-list-subList">
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=other')">
										其他报告
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
										...
										<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=otherMethod')">
										其他评测方法
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
							...
							<ul class="nav-list">
								...
								<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=feedbackPoint')">
										评价等级
...
"ico-arr-bdr">&#9670;</span>
								...
								<li class="nav-list-item">
									<div class="nav-list-item-title"
										onclick="oa.go('index.php?name=Spark&childPage=feedbackContent')">
										反馈内容
										<b class="ico ico-arr ico-arr-l"><span
											class="ico-arr-main">&#9670;</span><span class=
"ico-arr-bdr">&#9670;</span>
	...
	<script type="text/javascript">
		// 切换内容demo
		oa.go('index.php?name=Spark&childPage=summary');
	</script>
<footer>
  <div >
